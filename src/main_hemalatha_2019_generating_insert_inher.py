# -*- coding: utf-8 -*-
from stego_schemes.stego_hemalatha_inher_2019 import Hemalatha2019
...
def main():
    ...
    dir_dat_file = "%sDataSet_IV_Hemalatha2019.dat" % dir_dat_file
